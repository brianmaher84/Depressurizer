...
namespace Depressurizer
{
	public partial class DlgProfile : Form
	{
		...
		public string GetDisplayName(long accountId)
		{
			...
			{
				Program.Logger.Warn(GlobalStrings.DlgProfile_ExceptionRaisedWhenTryingScrapeProfileName, accountId);
		...
		private bool Apply()
		{
			...
			{
				using (GetSteamIDDialog dialog = new GetSteamIDDialog(txtUserUrl.Text))
				{
