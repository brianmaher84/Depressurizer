...
namespace Depressurizer
{
	public class Profile
	{
		...
		{
			Program.Logger.Info(GlobalStrings.Profile_SavingProfile, path);
			...
			{
				Program.Logger.Error(GlobalStrings.Log_Profile_ConfigBackupFailed, e.Message);
			}
			...
			{
				Program.Logger.Warn(GlobalStrings.Profile_FailedToOpenProfileFile, e.Message);
			...
			writer.Close();
			FilePath = path;
			Program.Logger.Info(GlobalStrings.Profile_ProfileSaveComplete);
			return true;
		}
